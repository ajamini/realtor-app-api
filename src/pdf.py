...
def fill(input_pdf_path, output_pdf_path, data_dict):
                        ...
                        if annotation[ANNOT_FIELD_KEY]:
                              ...
                              if key in data_dict.keys():
                                    if type(data_dict[key]) == bool:
                                          ...
                                          annotation[ANNOT_PARENT].update(pdfrw.PdfDict(V='{}'.format(data_dict[key])))
                                          annotation[ANNOT_PARENT].update(pdfrw.PdfDict(AP=''))
